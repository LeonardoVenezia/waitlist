      ...
      <div className="w-full max-w-2xl mx-auto">
        <EditorialCard>
          <div className="space-y-6 text-left">
            <h2 className="text-3xl font-bold text-neutral-900">You&apos;re on the list.</h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
        ...
        <div className="lg:col-span-7 text-left">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-neutral-900 leading-[1.05]">
            {data.title}{" "}
            {data.title_italic && (
              <span className="font-serif italic font-normal" style={{ color: data.accent_color }}>
                {data.title_italic}
              </span>
            )}
          </h1>
          ...
          <form onSubmit={handleSubmit} className="mt-8 max-w-lg">
            <div className="flex items-stretch overflow-hidden rounded-lg border-2 border-neutral-900 focus-within:ring-2 focus-within:ring-offset-2 transition" style={{ ["--tw-ring-color" as string]: data.accent_color }}>
              <input
                type="email"
                required
