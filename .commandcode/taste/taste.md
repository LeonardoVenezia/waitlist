...
- When reporting bugs in their own app, user includes concrete diagnostic evidence (exact endpoint URL, HTTP status code, and response body) alongside the symptom, rather than only describing what they see. Confidence: 0.60
